...
namespace Ju.Random
{
	public class OpenSimplex2FastNoise : INoise
	{
		...
		{
			return Sample2D(x, 0f);
		}

		public float Sample2D(float x, float y)
		{
			return (float)Noise2((float)x, (float)y);
		}

		public float Sample3D(float x, float y, float z)
		{
			return (float)Noise3_Classic((float)x, (float)y, (float)z);
		}

		public float Sample4D(float x, float y, float z, float w)
		{
			return (float)Noise4_Classic((float)x, (float)y, (float)z, (float)w);
		}
